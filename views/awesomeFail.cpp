...
void FractureView::initialize() {
  ...
  //}
  periSystem->getPointMasses()->get(44)->getExternelForces()->add(new Vec3d(0.0,0.0,-60.0));
  periSystem->getPointMasses()->get(45)->getExternelForces()->add(new Vec3d(0.0,0.0,-60.0));
  periSystem->getPointMasses()->get(54)->getExternelForces()->add(new Vec3d(0.0,0.0,-60.0));
